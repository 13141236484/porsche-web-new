  ...
  <div class="page-agency-search">
    ...
    <div class="main-kv">
			...
			<div class="ui-content">
				<div class="md-agency">
					<div class="agency-content content-form">
						<h3 class="content-title">经销商查询</h3>
						<p class="tips block-pc">
							尊敬的挚享汇会员，如果您想查询保时捷的经销商地址，直接选择地区即可。
						</p>
						<p class="tips block-mobile">
							尊敬的挚享汇会员，<br/>
							如果您想查询保时捷的经销商地址，直接选择地区即可。
						</p>
            <div class="select-selection">
              <select class="select-hidd" name="">
                <option value="">请选择您想查询的地区</option>
              </select>
              ...
              <span class="span-select  span-select-nr1" @mouseleave="spanshow1()" v-if="spanselect1">
            ...
            <div class="select-selection">
              ...
              <span class="span-select span-select-nr2"  @mouseleave="spanshow2()" v-if="spanselect2">
                <span class="span-select-nr ">
                  <ul >
                    <li>请选择经销商</li>
            ...
            <div class="center-result" v-if="this.zhongxnr != ''">
				<div class="md-center">
				...
				<div class="reserve-btn">
					<a class="ui-btn btn-lg btn-block btn-contact but-collan" @click="offlinecdealerapp()">请经销商联系我</a>
				</div>

			</div>
			<div class="agency-content content-result">
				<h3 class="content-title block-pc">经销商查询</h3>
				<div class="center">
              ...
              <p class="result-tips">我们会尽快安排经销商联系您，<br>敬候您的到来！</p>
						<div class="reserve-btn">
...
export default {
  ...
  data() {
    return {
      ...
      zhongxnrpc:'',
      addressnrpc:'',
      provinceval:'请选择您想查询的地区',
      centerval:'请选择您要查询的保时捷中心',
      bgshow: "",
      spanselect1:false,
      spanselect2:false,
      PORSCHE_HOST,
  ...
  methods: {
                ...
                success: function (res) {
                  ...
                  if(res.code === "1001") {
                    ...
                    for(let i=0;i<res.data.length;i++){
                        ...
                        trigger: '#day1',
                        wheels: [{data:_this.appprovincelist}],
                        position:[2], //初始化定位,
    ...
    offlinecdealerapp(){
      ...
      $.ajax({
              ...
              url: PORSCHE_HOST+'/member/offline/dealer',
              success: function (res) {
                if(res.code === "1004") {
                    _this.$router.push('/login');
                    return ;
    ...
    setswiper() {
      ...
      let zongpc_height = parseInt(l_height) - parseInt(270);
      if (document.body.offsetWidth > 750) {
        this.bgshow = require('../../common/image/rexervepc.jpg');
        //$(".main-kv").height(zongpc_height)
       /* $(".kv-img").css("left", -$(".md-agency").width()/6 + 'px')
        $(".kv-img").height(zongpc_height -$(".md-agency").width()/6)*/
      } else {

      ...
      <a @click="back" class="back"><i class="back-con"><img :src="require('../../common/image/back.png')" alt=""></i></a>
        ...
        <div class="enjoyFmemotion-bottom">
          ...
          <div class="enjoyFmemotion-bottom-nr">
            <router-link  :to="{ path: '/emotionlist/'+list.uuid }" v-for="(list,index) in emotionList" :key="index">
            <div class="enjoyFmemotion-bottom-shadowlist" >
                  <div class="enjoyFmemotion-bottom-nrleft" :key="index">
...
export default {
  ...
  data() {
    return {
      ...
      offset:0,
      count:10,
      messages :require('../../common/image/fenx2.png'),
      PORSCHE_HOST,
      type:'TRACK',
      topimg:'',
      emotionList: [],
  ...
  methods: {
    ...
    enter1(){
        this.messages = require('../../common/image/fenx2-1.png');
    },
    leave1(){
        this.messages = require('../../common/image/fenx2.png');
    },
    show() {
      if (document.body.offsetWidth > 750) {
        this.topimg = require('../../common/image/pcimg/rqsd-bga.jpg');
      } else {
        this.topimg = require('../../common/image/appimg/rqsd-bga.jpg');
      }
    },
    timedata(time){

  ...
  <div class="porsche-enjoyFm-emotion">
      <a @click="back" class="back"><i class="back-con"><img :src="require('../../common/image/back.png')" alt=""></i></a>
        <div class="enjoyFmemotion-top">
          <div class="top-text">
          　 <h3>梦想起航</h3>
              <p>当梦想成真,分享成为保时捷车主后的激动与感怀</p>
          </div>
            <img class="cover" id="enjoyFmshare-top-nrimgid" style="width: 100%;"  :src="topimg" alt="">
            <div class="referrer-box">
                <p class="referrer-gift" @mouseenter="enter2" @mouseleave="leave2" @click="opens"> <img   :src="this.messages1" alt=""></p>
            </div>
        </div>
        <div class="enjoyFmemotion-bottom">
          ...
          <div class="enjoyFmemotion-bottom-nr">
            <router-link  :to="{ path: '/dreamlist/'+list.uuid }" v-for="(list,index) in emotionList" :key="index">
...
export default {
  ...
  data() {
    return {
      ...
      offset:0,
      count:10,
      messages :require('../../common/image/share_03.png'),
        messages1 :require('../../common/image/pcimg/gift_03.png'),
      PORSCHE_HOST,
      type:'DREAMSAIL',
      topimg: '',
      emotionList: [],
  ...
  methods: {
      ...
      opens(){
          ...
          $.ajax({
              type: 'post',
              url: PORSCHE_HOST+'/member/show/dream/countAdd',
          ...
          window.open("https://www.porsche-referral.com.cn/?refSource=Nurturing");
      },
    enter1(){
        this.messages = require('../../common/image/share_05.png');
    },
    leave1(){
        this.messages = require('../../common/image/share_03.png');
    },
      enter2(){
          this.messages1 = require('../../common/image/pcimg/gift_05.png');
      },
      leave2(){
          this.messages1 = require('../../common/image/pcimg/gift_03.png');
      },
    show() {
      if (document.body.offsetWidth > 750) {
        this.topimg = require('../../common/image/pcimg/dream.jpg');
      } else {
        this.topimg = require('../../common/image/appimg/dream.jpg');
      }
    },
    timedata(time){

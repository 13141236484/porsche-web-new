            ...
            <div class="common-content-appnr">
              ...
              <div class="porsche-comment-list">
                <div class="comment-item" style="margin-top: 40px;">
                	<img  class="item-avatar lazy" :src="useravatar != null  && useravatar != 'null'  && useravatar != ''? PORSCHE_HOST+useravatar:require('../common/image/180126.jpg')" style="display: block;">
                  <h4 class="xpl">写评论</h4>
...
export default {
  ...
  methods: {
    ...
    //           type: 'post',
    //           data: {
    //             id:parseInt(_this.articleId)
    //           },
    //           url: PORSCHE_HOST+'/member/fm/comment/list',
    //           success: function (res) {
    //               if(res.code === "1001") {
    ...
    likeCmment(uuid){
      ...
      $.ajax({
              ...
              url: PORSCHE_HOST+'/member/fm/comment/upvote',
              success: function (res) {
                if(res.code === "1004") {
                    _this.$router.push('/login');
                    return ;
    ...
    addCmment(){
      ...
      $.ajax({
              ...
              url: PORSCHE_HOST+'/member/fm/comment/add',
              success: function (res) {
                if(res.code === "1004") {
                    _this.$router.push('/login');
                    return ;
    ...
    addCmmentThe(){
      ...
      $.ajax({
              ...
              url: PORSCHE_HOST+'/member/fm/comment/reply',
              success: function (res) {
                if(res.code === "1004") {
                    _this.$router.push('/login');
                    return ;
    ...
    imagesshow(index){
      ...
      var viewer;
         viewer = new Viewer(document.getElementById(index),{
             toolbar:false,
             title:false,
             url: 'data-original',
             show:function(){

...
<div class="porsche-comment">
            ...
            <div class="common-content-appnr">
              ...
              <div class="porsche-comment-list">
                <div class="comment-item" style="margin-top: 40px;">
                	<img  class="item-avatar lazy" :src="avataruser != null && avataruser != 'null'  && avataruser != ''? PORSCHE_HOST+avataruser:require('../common/image/180126.jpg')" style="display: block;">
                  <h4 class="xpl">写评论</h4>
  ...
  <div>
    <!-- <span id="images">
      <img src="http://test.porsche-fan.com/service/uploads/77514431-e87f-4e8c-88a3-2d8eb6d246f7.jpg" alt="Picture">
      <img src="http://test.porsche-fan.com/service/uploads/77514431-e87f-4e8c-88a3-2d8eb6d246f7.jpg" alt="Picture 2">
    </span> -->
  </div>
</div>
</template>
  ...
  methods: {
    ...
    getCmment(val){
      ...
      $.ajax({
              ...
              url: PORSCHE_HOST+'/member/driver/comment/list',
              success: function (res) {
                if(res.code === "1004") {
                    _this.$router.push('/login');
                    return ;
    ...
    likeCmment(uuid){
      ...
      $.ajax({
              ...
              url: PORSCHE_HOST+'/member/driver/comment/upvote',
              success: function (res) {
                if(res.code === "1004") {
                    _this.$router.push('/login');
                    return ;
    ...
    addCmment(){
      ...
      $.ajax({
              ...
              url: PORSCHE_HOST+'/member/driver/comment/add',
              success: function (res) {
                if(res.code === "1004") {
                    _this.$router.push('/login');
                    return ;
